                ...
                @endif
	              ...
	              <form role="form" id="add-blog" method="post" enctype="multipart/form-data" action="{{ route('admin.blog.add.store')}}"  >
                    ...
                    <div class="form-group date">
                      ...
                      <input type="text" class="form-control" placeholder="Start Time" name="start_time" id="start_time" >
                    ...
                    <div class="form-group date">
                      ...
                      <input type="text" class="form-control" placeholder="End Time" name="end_time" id="end_time" >
