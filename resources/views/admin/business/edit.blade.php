          ...
          <div class="box">
                ...
                @endif
                  ...
                  <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="Title" name="title" value="{{ $businessDetails->title }}" >
                            @if ($errors->has('title'))
                    ...
                    <div class="form-group">
                        ...
                        <textarea type="text" class="form-control" placeholder="Description" name="description" >{{ $businessDetails->description }}</textarea>
                    ...
                    <div class="form-group">
                        ...
                        @endif
                        @if($businessDetails->image)
                            <img class="showUploadedImage" src="{{ $businessDetails->image }}" width="50"  />
                        @endif
                    </div>
